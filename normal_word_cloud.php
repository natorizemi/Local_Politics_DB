...
<html lang="en">
  ...
  <body>
   ...
   $sql = "SELECT * FROM hatugen WHERE id_hatugen !=1";
   $stmt = $dbh->query($sql);
...
foreach ($result as $val) {
  ...
  }else if( $tmp[1] == '動詞' ){//'お'の削除
     $integrated_word .= $tmp[0];
     unset( $integrated_word );
  }else{
     $negative_word_list_index = array("議員", "問目", "点目", "質問", "お願い", "お答え", "お尋ね", "ご答弁", "平成", "お考え", "ご説明", "ページ", "ご指摘", "新た", "答弁", "質疑", "考え", "さまざま", "議案", "皆さん", "たち");
